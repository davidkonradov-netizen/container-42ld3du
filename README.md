...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-42ld3du.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-42ld3du.containers.anotherwebservice.com/
...
```
git clone git@github.com:davidkonradov-netizen/container-42ld3du.git
cd container-42ld3du
```
...
```
docker attach container-42ld3du
```
